	...
	public CustomPanel(JFrame parent, Color c, String title) {
		...
		ActionListener listener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JPanel nextPanel = MainFrame.panels[index]; //MainFrame의 panels의 index번지를 참조함
				MyUtil.changePanel(parent,CustomPanel.this,nextPanel); //여기서 this는 내부클래스 ActionListener객체로 넘어간다
