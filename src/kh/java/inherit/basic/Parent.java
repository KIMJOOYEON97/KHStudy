 ...
 * 
 * 상속 Inheritance
 * 부모클래스가 가지고 있는 member변수/메소드를 자식 클래스에서 선언하지 않고,
 * 사용할 수 있게 하는 것.
 * 
 * 
 ...
 * 
 * 특징
 * 1. 부모클래스 필드/메소드는 자식클래스에서 선언없이 접근 가능
 ...
 * 		- 부모클래스 생성자 호출 super();
 * 4. 부모클래스의 메소드는 자식클래스에서 재작성해서 사용할 수 있다.
 * 5. 부모클래스의 private필드/메소드는 상속은 되지만, 직접접근 할 수 없다.
 * 		- getter/setter를 이용
 * 		- (setter할 때)값 대입할 시에 부모생성자 super를 호출해서 부모클래스 안에서 값대입
 */
